...
API_ENERGY_GET_CURRENT_PARAMETERS = "get_current_parameters/"
API_ENERGY_GET_TOTAL_ENERGY = "get_total_energy/"
...
DEVICES = {
    ...
    DEVICE_TYPE_ENERGY: DEVICE_MODEL_ENERGY
}
...
DEVICE_PLATFORM = {
    ...
    DEVICE_TYPE_ENERGY: SUPPORTED_PLATFORM_SENSOR
}

#Service discovery values
DEVICE_DISCOVERY_RESPONSE_HEADER = 'F&F-WiFi-device-discovery-response:1'
DEVICE_DISCOVERY_REQUEST_HEADER = 'F&F-WiFi-device-discovery-request:1'
MIN_DATA_SIZE_TO_PARSE = 45
